...
// 存储组件列表
const components = [CommonDetail,CommonDetails,Chart,Form,SelectTimeRange,Table];
...
export {  KeepAlive,CommonDetail,CommonDetails,Chart,Form,SelectTimeRange,Table };
export default {
